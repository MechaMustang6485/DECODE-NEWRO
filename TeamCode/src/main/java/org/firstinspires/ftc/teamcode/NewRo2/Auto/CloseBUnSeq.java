...
public final class CloseBUnSeq extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder move = drive.actionBuilder(new Pose2d(0, 0, 0))
                ...
                .waitSeconds(0.3)
                .stopAndAdd(new org.firstinspires.ftc.teamcode.NEWRO.Auto.BackB6.armAction(arm, 0.3))
                .stopAndAdd(new org.firstinspires.ftc.teamcode.NEWRO.Auto.BackB6.armAction(arm, 0))
                ...
                .stopAndAdd(new org.firstinspires.ftc.teamcode.NEWRO.Auto.BackB6.Intake(intake, 1))
