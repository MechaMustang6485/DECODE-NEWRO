...
@Config
@Autonomous
public final class BackFoward9Blue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder move = drive.actionBuilder(new Pose2d(0, 0, 0))
                ...
                .waitSeconds(0.4)
                .strafeToLinearHeading(new Vector2d(29, 0.0049), Math.toRadians(0), (pose2dDual, posePath, v) -> 80)
                .stopAndAdd(Revolver.setTarget(240))
                .waitSeconds(0.2)
                .stopAndAdd(new armAction(arm, 0.3))
                .stopAndAdd(new armAction(arm, 0))
               ...
               .strafeToLinearHeading(new Vector2d(30, 0.89), Math.toRadians(0), (pose2dDual, posePath, v) -> 80)
                 */
